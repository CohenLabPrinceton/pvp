from pvp.io.devices import I2CDevice, be16_to_native
...
class AnalogSensor(Sensor):
    ...
    def __init__(self, adc, **kwargs):
        ...
        Args:
            adc (pvp.io.devices.ADS1115): The adc object to which the AnalogSensor is attached
            **kwargs: `field=value` - see pvp.io.devices.ADS1115 for additional documentation. Strongly suggested to
    ...
    def _check_and_set_attr(self, **kwargs):
        ...
        Args:
            **kwargs: `field=value` - see pvp.io.devices.ADS1115 for additional documentation
        """
        allowed = (
