""" Base classes & functions used throughout pvp.io.devices
"""
from collections import OrderedDict
from pvp.common.fashion import pigpio_command
...
class ADS1115(I2CDevice):
    ...
    Default Values:
     Default configuration for pvp:     0xC3E3
    ...
    def config(self):
        ...
        Returns:
            pvp.io.devices.I2CDevice.Register: The Register object initialized for the ADS1115.
        """
        return self._config
    ...
    def _read_conversion(self, **kwargs) -> int:
        ...
        Args:
            **kwargs: see documentation of pvp.io.devices.ADS1115.read_conversion
        """
...
class ADS1015(ADS1115):
    ...
    def __init__(self, address=_DEFAULT_ADDRESS, i2c_bus=1, pig=None):
        """ See: pvp.io.devices.ADS1115.__init__
        """
