...
from pvp.io.devices import IODeviceBase
...
class Pin(IODeviceBase):
    ...
    any specialized pins or specific devices defined in pvp.io.actuators
    & pvp.io.sensors (note: actuators and sensors do not need to be tied
