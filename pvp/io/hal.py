...
class Hal:
    ...
    def __init__(self, config_file='pvp/io/config/devices.ini'):
        ...
        Args:
            config_file (str): Path to the configuration file containing the definitions of specific components on the
                ventilator machine. (e.g., config_file = "pvp/io/config/devices.ini")
        """
        ...
        for section in self.config.sections():
            ...
            class_ = getattr(import_module('.' + sdict['module'], 'pvp.io'), sdict['type'])
